function [er,params0,params1,spectral,reflFluspect,tranFluspect,leafopt,leafbio,leafopt_all, leafbio_all] = master
close all
progressbar
...
[er,params0,params1,spectral,reflFluspect,tranFluspect,leafopt,leafbio,leafopt_all, leafbio_all]  = Fluspect_retrievals(leafbio,c,include,target,measured,wl,wlrange);
...
mkdir(Output_dir)
copyfile('../data/input_data.xlsx',[Output_dir, 'output_data.xlsx'],'f')
...
xlswrite(outfile,leafbio_all.N','output','B7'  )
xlswrite(outfile,leafopt_all.rmse,'output','B8'  )
